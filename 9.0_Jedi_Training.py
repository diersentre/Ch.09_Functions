...
#  #put the variable num in for x. removed def increase(x) from under the print statement.
...
#added parentheses after defining count_to_ten
#changed [10] to (1,11)
...
print(reverse(text))
#
# added plus 1 to the text length
#
